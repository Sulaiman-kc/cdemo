...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~signup-signup-module~tabs-tabs-module"], {
  ...
  function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(afAuth, toastController, router) {
      ...
      _createClass(SignupPage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.prev = 2;
                    _context.next = 5;
                    return this.afAuth.createUserWithEmailAndPassword(username + '@gmail.com', password);
                  ...
                  case 10:
                    ...
                    if (_context.t0.code == 'auth/weak-password') {
        ...
        key: "user",
        value: function user(event) {
          console.log(event);
          this.username = event;
        }
      }, {
        key: "pass",
        value: function pass(event) {
          console.log(event);
          this.password = event;
        }
      }, {
  ...
  function srcAppTabsTabsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TabsPage = /*#__PURE__*/function () {
      function TabsPage(afAuth, toastController, router) {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.prev = 2;
                    _context3.next = 5;
                    return this.afAuth.signInWithEmailAndPassword(username + '@gmail.com', password);
...
//# sourceMappingURL=default~signup-signup-module~tabs-tabs-module-es5.js.map